...
<head>
	...
	<title>Search Results | Dog</title>
			...
			<div class="col-md-10" id="petList">
				<div  id="Avalible1"  class="col-md-2">
					<div class="img-thumbnail text-center">
						<img class="img-responsive" src="images/Lilly.jpg" alt="Lilly's Adoption Photo">
						<div>
							<h3>
							<?php
								$query = "SELECT petName FROM petTable WHERE petSpecies = 'Dog' AND petID = '0001'";
				...
				<div  id="Avalible1"  class="col-md-2">
					<div class="img-thumbnail text-center">
						<img class="img-responsive" src="images/Iggy.jpg" alt="Iggy's Adoption Photo">
						<div>
							<h3>
							<?php
								$query = "SELECT petName FROM petTable WHERE petSpecies = 'Dog' AND petID = '0011'";
								$result = sqlsrv_query($conn, $query);
								while($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC))
								{
									echo $row['petName'];	
